...
function Edu() {
  return (
   ...
   <div class="work" data-aos="fade-up">
      <h3>
        {/* <i class="fa fa-graduation-cap " id='briefcase'></i> */}
        Education</h3>
      <ul>
    ...
    <div class="edu">
      <h3>
        {/* <i class="fa fa-briefcase" id='cap'></i> */}
        Experience</h3>
      <ul>
        <li><span>Web Developer Intern</span><small>UFF Food Pvt. Ltd.</small><small>June 2021 - August 2021</small></li>
        <li><span>Web Developer</span><small>RCOEM Google Developer Student Club(GDSC)</small><small>August 2021 - June 2022</small></li>
