          ...
          <div className="main__edu">
            <div class="work" data-aos="fade-up">
              ...
              <ul>
                ...
                <li>
                  <span>Class 12</span>
                  <small>Santaji Mahavidyalaya, Nagpur</small>
                  <small>2017 - 2019</small>
                </li>
                <li>
                  <span>Class 10</span>
                  <small>TBRAN's Mundle English Medium School</small>
            ...
            <div class="edu">
              ...
              <ul>
                ...
                <li>
                  <span>Web Developer Intern [Remote]</span>
                  <small>UFF Food Pvt. Ltd.</small>
                  <small>June 2021 - August 2021</small>
                </li>
                <li>
                  <span>Web dev lead</span>
                  <small>RCOEM Google Developer Student Club(GDSC)</small>
                  <small>August 2021 - May 2023</small>
                </li>
                <li>
                  <span>Product Engineer Intern [Bangalore, KA]</span>
                  <small>OSlash(DemandWork Software Pvt. Ltd.)</small>
                  <small>December 2022 - June 2023</small>
                </li>
                <li>
                  <span>Frontend Developer Intern [Remote]</span>
                  <small>Ventura Securities</small>
